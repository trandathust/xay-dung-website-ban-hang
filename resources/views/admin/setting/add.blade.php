          ...
          <div class="card">
            <div class="card-body">
              <div class="row">
                <div class="form-group col-md-12">   
                  ...
                  <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" placeholder="Nhập tên">
                  @error('name')
                ...
                <div class="form-group col-md-12">   
                  ...
                  <input type="text" name="config_value" id="config_value" class="form-control @error('config_value') is-invalid @enderror" placeholder="ví dụ: https://www.facebook.com/">
                  @error('config_value')
                  <div class="alert alert-danger">{{ $message }}</div>
                  @enderror
                </div>
                <div class="form-group col-md-12">   
                  ...
                  <input type="text" name="config_key" id="config_key" class="form-control @error('config_key') is-invalid @enderror" placeholder="ví dụ: fa fa-facebook">
                  @error('config_key')
                  <div class="alert alert-danger">{{ $message }}</div>
                  @enderror
                </div>
            ...
            <div class="card-footer">
              <div class="row justify-content-md-center">
                <button  data-url = "{{route('admin.addsetting')}}" class="btn btn-primary btn-sm btn-submit-icon">Thêm mới</button>
              </div>
            </div>
          </div>
          <!-- /.card -->
            ...
            <div class="card-body">
              <div class="row">
                <div class="form-group col-md-12">   
                  ...
                  <input type="text" name="nameshop" id="nameshop" class="form-control @error('nameshop') is-invalid @enderror" placeholder="Nhập tên cửa hàng" value="{{$nameshop}}">
                  @error('nameshop')
                  <div class="alert alert-danger">{{ $message }}</div>
                  @enderror
                </div>
