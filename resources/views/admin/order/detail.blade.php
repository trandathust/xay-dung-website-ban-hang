        ...
        <table id="example2" class="table table-bordered table-hover">
              ...
              <td colspan="7">
                ...
                <table class="table table-condensed total-result">
                  ...
                  <tr>
                    ...
                    <td>
                      <form method="POST">
                        ...
                        <select class="form-control" id="select_id" name="select_name" data-url="{{route('admin.updateorder',['id' => $findorder -> id])}}">
                          @foreach($status as $row)
                          <option value="{{$row -> id}}" @if($row -> id == $findorder -> status_id) selected="selected" @endif>{{$row -> display_name}}</option>
                          @endforeach
                        </select>
                      </form>
                    </td>
                  ...
                  <tr>
                    ...
                    <td></td>
                    <td><button class="action_delete btn btn-danger btn-sm" data-url="{{route('admin.deleteorder',['id' => $findorder -> id])}}"><i class="fas fa-times"> </i> Xóa Đơn Hàng</button></td>
                  </tr>
                </table>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{{$item -> id}}</td>
              <td><img class="image-cart-70-100" src="{{$item -> feature_image_path}}"></td>
              <td>{{$item -> name}}</td>
              <td>
