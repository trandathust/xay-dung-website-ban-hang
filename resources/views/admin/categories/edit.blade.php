...
<div class="content-wrapper">
 ...
 @include('admin.general.content-header',['name' => 'Sửa Danh Mục'])
 <!-- /.content-header -->
 <div class="content">
          ...
          <div class="card">
            ...
            <div class="card-footer">
              <div class="row justify-content-md-center">
                <button data-url="{{route('admin.editcategory',['id'=>$category->id])}}" class="btn btn-primary btn-sm btn_category">Lưu</button>
              </div>
            </div>
          </div>
          <!-- /.card -->
...
<!-- DataTables -->
  ...
  <script src="{{asset('vendor/admin/category/edit.js')}}"></script>
