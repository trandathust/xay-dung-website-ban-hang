                        ...
                        <div class="card">
                            ...
                            <div class="card-footer">
                                <div class="row justify-content-md-center">
                                    <button data-url="{{route('admin.addcategory')}}"
                                        class="btn btn-primary btn-sm btn_category">Thêm mới</button>
                                </div>
                            </div>
                        </div>
                    </form>
                            ...
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$row->name}}</td>
                                        <td>
                                            <a href="{{route('admin.editcategory',['id' => $row -> id])}}"
                                                class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></a>
                                            <a href="" data-url="{{route('admin.deletecategory',['id' => $row -> id])}}"
