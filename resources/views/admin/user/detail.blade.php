...
<div class="content-wrapper">
 ...
 @include('admin.general.content-header',['name' => 'Xem Người Dùng'])
 <!-- /.content-header -->
 <div class="content">
...
<div class="row flex-container justify-content-center">
  <div class="col col-md-2">
    <a href="{{route('admin.edituser',['id' => $user -> id])}}" class="btn btn-primary"><b>Sửa</b></a>
  </div>
  <div class="col col-md-2">
    <a href="{{route('admin.softdeleteuser',['id' => $user -> id])}}" onclick="return confirm('Xác nhận?')" class="btn btn-danger"><b>Nghỉ Việc</b></a>
  </div>
  <!-- /.card-body -->
</div>
<!-- /.card -->
