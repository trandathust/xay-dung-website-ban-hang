          ...
          <div class="card">
            ...
            <div class="card-footer">
              <div class="row justify-content-md-center">
                <button data-url = "{{route('admin.posteditsupplier',['id' => $supplier -> id])}}" class="btn btn-primary btn-sm btn-submit-supplier">Lưu</button>
              </div>
            </div>
          </div>
          <!-- /.card -->
...
<!-- DataTables -->
  ...
  <script src="{{asset('vendor/admin/supplier/edit.js')}}"></script>
