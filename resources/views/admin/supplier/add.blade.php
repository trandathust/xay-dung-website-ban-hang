                        ...
                        <div class="card">
                            ...
                            <div class="card-footer">
                                <div class="row justify-content-md-center">
                                    <button data-url="{{route('admin.postsupplier')}}"
                                        class="btn btn-primary btn-sm btn-submit-supplier">Thêm mới</button>
                                </div>
                            </div>
                        </div>
                    </form>
                            ...
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$row->address}}</td>
                                        <td>
                                            <a href="{{route('admin.editsupplier',['id' => $row -> id])}}"
                                                class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></a>
                                            <a href="" data-url="{{route('admin.deletesupplier',['id' => $row -> id])}}"
