...
<div class="content-wrapper">
 ...
 <div class="content justify-content-md-center">
  ...
  <form action="{{route('admin.posteditblog',['id'=>$dataBlog -> id])}}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="card">
      <div class="card-body">
        <div class="row">
          <div class="col form-group col-md-12">   
            ...
            <input type="text" name="title" id="title" class="form-control @error('title') is-invalid @enderror" placeholder="Nhập tiêu đề" value="{{$dataBlog -> title}}">
            @error('title')
          ...
          <div class="col form-group col-md-2">
            <div class="checkbox">
              ...
              <br>
              <input type="checkbox" value="1" name="status" id="status" @if($dataBlog -> status ==1) checked @endif>
            </div>
          </div>
          <div class="col-md-12">
          ...
          <div class="col form-group col-md-12">
            ...
            <textarea class="form-control tinymce_editor_init error-messages @error('title') is-invalid @enderror" rows="15" name="content" placeholder="Nội dung bài viết..." >{{$dataBlog -> content}}</textarea>
            @error('content')
            <div class="alert alert-danger">{{ $message }}</div>
            @enderror
          </div>
