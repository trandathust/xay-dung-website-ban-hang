          ...
          <div class="card">
            <div class="card-body">
              <div class="row">
                ...
                <div class="form-group col-md-12">   
                  ...
                  <input type="text" name="url" id="url" class="form-control @error('url') is-invalid @enderror" placeholder="Nhập đường dẫn">
                  @error('url')
                  <div class="alert alert-danger">{{ $message }}</div>
                  @enderror
                </div>
            ...
            <div class="card-footer">
              <div class="row justify-content-md-center">
                <button data-url = "{{route('admin.addmenu')}}" class="btn btn-primary btn-sm btn-submit-menu">Thêm mới</button>
              </div>
            </div>
          </div>
          <!-- /.card -->
