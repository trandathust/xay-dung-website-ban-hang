        ...
        <div class="row">
            <div class="col-sm-2">
                <div class="text-left">
                    ...
                    <img class="profile-user-img img-fluid img-circle image-avatar" src="{{$user->avatar_path}} "
                        alt="Avatar">
                    @else
                    <img class="profile-user-img img-fluid img-circle image-avatar"
                        src="{{asset('adminlte/dist/img/avatar04.png')}}" alt="User profile picture">
                    @endif
                ...
                <div class="left-sidebar">
                    <div class="panel-group category-products" id="accordian">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title"><a href="{{route('customer.getorder')}}"
                                        style="color: #FE980F">Đơn Mua</a></h4>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-sm-9 padding-right">
                <div class="role">
                    <div class="col col-sm-2">
                        <a href="{{route('customer.getorder')}}" type="button" class="btn btn-primary btn-block">Tất
                            Cả</a>
                    </div>
                    <div class="col col-sm-2">
                        <a href="{{route('customer.getorder'). '?type=waiting'}}" type="button"
                            class="btn btn-css btn-block">Chờ Soạn Hàng</a>
                    </div>
                    <div class="col col-sm-2">
                        <a href="{{route('customer.getorder'). '?type=delivery'}}" type="button"
                            class="btn btn-css btn-block">Đang Giao</a>
                    </div>
                    <div class="col col-sm-2">
                        <a href="{{route('customer.getorder'). '?type=received'}}" type="button"
                            class="btn btn-css btn-block">Đã Nhận</a>
                    </div>
                    <div class="col col-sm-2">
                        <a href="{{route('customer.getorder'). '?type=cancelled'}}" type="button"
                            class="btn btn-css btn-block">Đã Hủy</a>
                    </div>
                </div>
                <br>
                <br>
                                ...
                                <td colspan="3">
                                    <table>
                                        ...
                                        <tr>
                                            <td></td>
                                            <td>
                                                @if($order -> status_name == 'received' || $order -> status_name ==
                                                'cancelled')
                                                <form method="POST" action="">
                                                    <a href="{{route('customer.reOrder',['id'=>$order -> id])}}"
                                                        class="btn btn-primary ">ĐẶT LẠI</a>
                                                </form>
                                                @endif
                                            </td>
            ...
            <div class="col-sm-9 padding-right">
                <div class="role">
                    ...
                    <div class="col col-sm-2">
                        <a href="{{route('customer.getorder'). '?type=waiting'}}" type="button"
                            class="btn btn-primary btn-block">Chờ Soạn Hàng</a>
                    </div>
                    <div class="col col-sm-2">
                        <a href="{{route('customer.getorder'). '?type=delivery'}}" type="button"
                            class="btn btn-css btn-block">Đang Giao</a>
            ...
            <div class="col-sm-9 padding-right">
                <div class="role">
                    ...
                    <div class="col col-sm-2">
                        <a href="{{route('customer.getorder'). '?type=delivery'}}" type="button"
                            class="btn btn-primary btn-block">Đang Giao</a>
                    </div>
                    <div class="col col-sm-2">
                        <a href="{{route('customer.getorder'). '?type=received'}}" type="button"
                            class="btn btn-css btn-block">Đã Nhận</a>
            ...
            <div class="col-sm-9 padding-right">
                <div class="role">
                    ...
                    <div class="col col-sm-2">
                        <a href="{{route('customer.getorder'). '?type=received'}}" type="button"
                            class="btn btn-primary btn-block">Đã Nhận</a>
                    </div>
                    <div class="col col-sm-2">
                        <a href="{{route('customer.getorder'). '?type=cancelled'}}" type="button"
                            class="btn btn-css btn-block">Đã Hủy</a>
            ...
            <div class="col-sm-9 padding-right">
                <div class="role">
                    ...
                    <div class="col col-sm-2">
                        <a href="{{route('customer.getorder'). '?type=cancelled'}}" type="button"
                            class="btn btn-primary btn-block">Đã Hủy</a>
                    </div>
                </div>
                <br>
                <br>
