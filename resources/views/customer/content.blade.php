        ...
        <div class="row">
            ...
            <div class="col-sm-9 padding-right">
                ...
                <div class="recommended_items">
                    <!--recommended_items-->
                    <h2 class="title text-center"><a style="color: #FE980F" href="{{route('getSale')}}">SẢN PHẨM GIẢM
                            GIÁ</a></h2>
                                            ...
                                            <div class="single-products">
                                                <div class="productinfo text-center">
                                                    <a href="{{route('getProductDetail',['id' => $item -> id])}}"><img
                                                            ...
                                                            alt="" /></a>
                                                    <h2>
                                                        @if($item -> price == $item -> price_sale || $item -> price_sale
                                                        == null || $mytime > $item -> end_sale)
                                                        {{number_format($item-> price)}}
                                                        @else
                                                        <del style="color: #4a4946"><span
                                                                style="color: #4a4946">{{number_format($item-> price)}}</span></del>
