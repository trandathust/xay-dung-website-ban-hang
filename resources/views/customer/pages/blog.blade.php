			...
			<div class="col-sm-9">
					<div class="blog-post-area">
						...
						<div class="single-blog-post">
							<a href="{{route('getsingerblog',['id'=>$blog -> id , 'slug' =>$blog -> slug])}}" style="color: #4f4f4f" target="_blank"><h2>{{$blog -> title}}</h2></a>
							<div class="post-meta">
								<ul>
							...
							<a  class="btn btn-primary" href="{{route('getsingerblog',['id'=>$blog -> id , 'slug' =>$blog -> slug])}}" target="_blank"> Đọc Thêm</a>
