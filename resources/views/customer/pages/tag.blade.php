		...
		<div class="row">
			...
			<div class="col-sm-9 padding-right">
				<div class="features_items"><!--features_items-->
					<h2 class="title text-center">TAG : {{($nameTag)}}</h2>
					@foreach($productOfTag -> product as $item)
					<form id="add_cart_category">
						@csrf
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										...
										<h2>
											@if($item -> price == $item -> price_sale || $item -> price_sale == null || $timenow > $item -> end_sale)
