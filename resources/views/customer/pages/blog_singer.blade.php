						...
						<div class="row">
							...
							<div class="col-sm-12">
								<div class="text-area">
									...
									<textarea name="comment" id="comment" rows="5" placeholder="Viết bình luận..."></textarea>
									<input type="hidden" name="user_id" id="user_id" value="{{auth()->user()-> id}}">
									<input type="hidden" name="blog_id" id="blog_id" value="{{$dataBlog-> id}}">
									<a class="btn btn-primary submit_comment" href="" data-url="{{route('blogcomment',['id'=>$dataBlog -> id])}}">Gửi</a>
								</div>
							</div>
						</div>
					</form>
