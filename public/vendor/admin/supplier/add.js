    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.code == 200) {
                ...
                html += '<td>' + address + '</td>';
                html += '<td> <a href="/admin/supplier/edit/' + id + '" class="btn btn-primary btn-sm" ><i class="fas fa-edit"></i></a>' + '<a href="" data-url ="/admin/supplier/delete/' + id + '" type="button" class="btn btn-danger btn-sm action_delete"><i class="fas fa-times" ></i ></a></td></tr>'
